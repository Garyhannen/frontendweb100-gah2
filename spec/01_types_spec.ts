...
describe('types', () => {
    describe('declaring variables ', () => {
        ...
        it('a const keyword', () => {
            ...
            const favoritNumbers = [1, 2, 3, 4, 5, 6];
            //favoritNumbers = [20,108];

            favoritNumbers[0] = 108;
            ...
            movie.yearRelease = 1977;
        });
        it('why is var is bad for your health', () => {
            const age = 22;
...
line
                ...
                const title = 'Walden', auther = 'Thoreau';
        ...
        describe('object literals', () => {
            ...
            it('an example', () => {
                ...
                const smallFoot: Movie = {
                    ...
                    director: 'Joe Schmidt',
                    financial: {
                        openingWeekend: 1_000_001,
                        totalBoxOffice: 3_252_832
                    },
                    cast: {
                        'Jim': 'Bill JonesLebron James',
                        'Kim': 'Rachel Maple'
                    }
                }
            });
